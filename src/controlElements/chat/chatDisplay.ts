...
export class ChatDisplay extends Window implements Renderable {
  ...
  reflesh(): void {
    ...
    this.sendButton.x = this.inputField.x + this.inputField.width + this.buttonRadius + 15;
    ...
    this.body
      .beginFill(0x9bcde8)
      .drawRect(0, 0, this.winWidth, this.winHeight - (this.navHeight + this.fHeight) * 0.5)
      .endFill();
